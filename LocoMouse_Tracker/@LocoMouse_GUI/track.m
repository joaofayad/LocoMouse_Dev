function [] = track(gui)
    ...
    if cpp
        ...
        for i_files = 1:Nfiles
            ...
            successful_tracking(i_files) = track_MATLAB_CPP(data,...
                model,...
                model_file,...
                calibration_file,...
                root_path,...
        ...
        for i_files = 1:Nfiles
            ...
            file_name = char(strtrim(video_list{i_files}));
            successful_tracking(i_files) = track_MATLAB_CPP(gui.data,...
                gui.data.model,...
                model_file,...
                calibration_file,...
                gui.root_path,...
                ...
                output_path,...
                bkg_fun,...
                gui.checkbox_overwrite,...
                gui.checkbox_save_figures.Value,...
                gui.popupmenu_parameters.Value,...
                cpp,...
                '',...
                gui);
        end
            ...
            if cpp
                if ispc
                    ...
                    [final_tracks_c,...
                        tracks_tail_c,...
                        data,...
                        debug] = locomouse_tracker_cpp_wrapper(data,...
                                                               root_path,...
                                                               model,...
                                                               calib,...
                                                               data.flip,...
